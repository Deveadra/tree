...
#         scan_setup_card = QGroupBox()
        ...
        self.scan_setup_grid.setHorizontalSpacing(LayoutMetrics.SPACING_MD)
        self.scan_setup_grid.setVerticalSpacing(LayoutMetrics.SPACING_SM)
        form = QFormLayout()
        ...
        self.basic_form.setHorizontalSpacing(LayoutMetrics.SPACING_MD)
        self.basic_form.setVerticalSpacing(LayoutMetrics.SPACING_SM)
        self.root_field_wrapper = QWidget()
        self.root_field_layout = QGridLayout(self.root_field_wrapper)
        self.root_field_layout.setContentsMargins(0, 0, 0, 0)
        self.root_field_layout.setHorizontalSpacing(LayoutMetrics.SPACING_SM)
        self.root_field_layout.setVerticalSpacing(LayoutMetrics.SPACING_XS)
        self.root_field_layout.addWidget(self.root_edit, 0, 0)
        self.root_field_layout.addWidget(self.browse_root_btn, 1, 0, alignment=Qt.AlignmentFlag.AlignRight)
        self.root_field_layout.setColumnStretch(0, 1)
        self.root_badge = QLabel("")
        self.basic_form.addRow("Root to scan:", self.root_field_wrapper)
        ...
        self.root2_field_layout.setContentsMargins(0, 0, 0, 0)
        self.root2_field_layout.setHorizontalSpacing(LayoutMetrics.SPACING_SM)
        self.root2_field_layout.setVerticalSpacing(LayoutMetrics.SPACING_XS)
        self.root2_field_layout.addWidget(self.root2_edit, 0, 0)
        self.root2_field_layout.addWidget(self.browse_root2_btn, 1, 0, alignment=Qt.AlignmentFlag.AlignRight)
        self.root2_field_layout.setColumnStretch(0, 1)
        self.root2_badge = QLabel("")
        self.basic_form.addRow("Root B (compare):", self.root2_field_wrapper)
        self.basic_form.addRow("", self.root2_badge)

        self.report_field_wrapper = QWidget()
        self.report_field_layout = QGridLayout(self.report_field_wrapper)
        self.report_field_layout.setContentsMargins(0, 0, 0, 0)
        self.report_field_layout.setHorizontalSpacing(LayoutMetrics.SPACING_SM)
        self.report_field_layout.setVerticalSpacing(LayoutMetrics.SPACING_XS)
        self.report_field_layout.addWidget(self.report_edit, 0, 0)
        self.report_field_layout.addWidget(self.browse_report_btn, 1, 0, alignment=Qt.AlignmentFlag.AlignRight)
        self.report_field_layout.setColumnStretch(0, 1)
        self.report_badge = QLabel("")
        self.basic_form.addRow("Reports root:", self.report_field_wrapper)
        ...
        self.adv_form.setHorizontalSpacing(LayoutMetrics.SPACING_MD)
        self.adv_form.setVerticalSpacing(LayoutMetrics.SPACING_SM)
        self.exclude_field_wrapper = QWidget()
        self.exclude_field_layout = QGridLayout(self.exclude_field_wrapper)
        self.exclude_field_layout.setContentsMargins(0, 0, 0, 0)
        self.exclude_field_layout.setHorizontalSpacing(LayoutMetrics.SPACING_SM)
        self.exclude_field_layout.setVerticalSpacing(LayoutMetrics.SPACING_XS)
        self.exclude_field_layout.addWidget(self.exclude_input, 0, 0)
        self.exclude_field_layout.addWidget(self.exclude_add_btn, 1, 0, alignment=Qt.AlignmentFlag.AlignRight)
        self.exclude_field_layout.setColumnStretch(0, 1)
        self.adv_form.addRow("Add exclude token:", self.exclude_field_wrapper)
...
#         self._update_scan_setup_layout_mode()
        ...
        self.secondary_scroll.setFrameShape(QScrollArea.Shape.NoFrame)
        self.secondary_scroll.setFocusPolicy(Qt.FocusPolicy.NoFocus)
        self.secondary_scroll.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Preferred)
        ...
        secondary_layout.addWidget(status_card, 0)
        ...
        secondary_layout.addWidget(summary_card, 0)
        ...
        self.actions_scroll.setFrameShape(QScrollArea.Shape.NoFrame)
        self.actions_scroll.setFocusPolicy(Qt.FocusPolicy.NoFocus)
        self.actions_scroll.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Preferred)
        self.actions_scroll_widget = QWidget()
        self.actions_scroll.setWidget(self.actions_scroll_widget)
        right_l.addWidget(self.actions_scroll, 0)
        actions_layout = QVBoxLayout(self.actions_scroll_widget)
        ...
        actions_layout.addLayout(trash_row)
    ...
    def _update_scan_setup_layout_mode(self) -> None:
        ...
        if compact:
            self.exclude_field_layout.setVerticalSpacing(LayoutMetrics.SPACING_XS)
            self.exclude_add_btn.setMaximumWidth(220)
        else:
            self.exclude_field_layout.setVerticalSpacing(LayoutMetrics.SPACING_XS)
